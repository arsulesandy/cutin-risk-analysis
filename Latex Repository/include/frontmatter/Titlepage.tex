...
{\Large \oneLineSubtitle{0.2cm}}\\[0.5cm]
...
{\Large (Student Name)} \setlength{\parskip}{2.9cm}
...
\begin{center}
	...
	\textbf{\Large \multiLineTitle{0.2cm}} \\[1cm]
        {\large \oneLineSubtitle{0.2cm}} \\[1cm]
	{\large (Student Name)}
...
%\oneLineSubtitle\\
(Thesis Title)\\
(Student Name)\setlength{\parskip}{1cm}

\copyright ~ (Student Name), \the\year. \setlength{\parskip}{1cm}

Supervisor: (Supervisor Name), Department of Computer Science and Engineering\\
Examiner: (Examiner Name), Department of Computer Science and Engineering\ \setlength{\parskip}{1cm}
