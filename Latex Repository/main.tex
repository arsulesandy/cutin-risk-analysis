...
% ==============================================================================
  ...
  \]
    ...
    highly critical guidance values around \SIrange{1.8}{2.0}{\second}, while safety-
    oriented reviews also report \SI{0.7}{\second} as a threshold used to characterise
    following too closely \cite{tscharn2018thw,souman2021quasar}. We choose
...
\bottomrule
    ...
    The dashboard was not developed from scratch. It builds on the official \textit{highD} tools repository, which provides functions for handling and visualising \textit{highD} data in Matlab and Python \cite{highd_tools_repo}. For this thesis, that tooling was adapted and extended with cut-in-specific event selection, cutter--follower highlighting, stage-window synchronisation, and context-signature/indicator panels needed for qualitative inspection of the reconstructed interaction pair.
...
\ForEach{frame $t$ in the analysis window around $t_0$}{
    ...
    The framework is parameterised through a small set of explicit settings (e.g., stability thresholds and stage windows). Each run produces versioned outputs (tables and figures) that can be regenerated from the same raw data and settings. The thesis-facing claims in Chapters~\ref{chap:results}--\ref{chap:conclusion} rely on the all-recordings reconstruction, stage-feature, and context-signature artifacts; exploratory predictive experiments included elsewhere in the repository are separate and are not used as evidence for the thesis claims. The intended entry point for reproducing the reported tables and figures is the project's reproducibility package or repository: \ArtifactURL.
...
% ==============================================================================
    ...
    \begin{thebibliography}{99}
        ...
        \bibitem{highd_tools_repo}
        R.~Krajewski.
        \newblock \emph{highD Tools}.
        \newblock GitHub repository containing Matlab and Python functions for handling and visualising \textit{highD} data.
        \newblock Available at \url{https://github.com/RobertKrajewski/highD-dataset} (accessed 2026-03-11).
        ...
        \newblock doi:10.1016/j.trf.2018.08.001.

        \bibitem{souman2021quasar}
        J.~Souman, K.~Adjenughwure, E.~van Dam, M.~van Weperen, and A.~Tejada.
        \newblock \emph{Quantification of Safe Driving}.
        \newblock TNO Report TNO 2021 R12632, 2021.
