...
\newcommand{\ThesisSubtitle}{\FrameworkName: An Space-Filling-Curve-based Trajectory-to-relation Reconstruction Approach for Overtaking
Scenarios of Automotive Vehicles}
...
% ==============================================================================
    ...
    On highD recordings 01--60, the framework yields 10,023 valid cut-in events and supports transparent risk labelling (2,018 risky under an execution-stage THW threshold of \SI{0.7}{\second}). Beyond scalar safety summaries, \FrameworkName{} introduces a direction-normalised interaction-context signature: a semantic occupancy grid encoded into a reversible 16-bit Hilbert SFC code. The signature is verified both algorithmically (exhaustive encode$\leftrightarrow$decode checks) and empirically (99.49\% exact row agreement against occupancy derived from highD neighbour relations over 1,421,980 verified rows)
